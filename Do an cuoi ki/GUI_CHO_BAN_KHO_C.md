# KHO C — CÀI TRƯỚC Ở NHÀ

> Bạn nhận file này sẽ làm **máy KHO C** (Kho Miền Nam, TP. Hồ Chí Minh) trong đồ án CSDL phân tán
...
> tên instance phải là `KHO_C`, mật khẩu `sa` phải là `123`, và phải tích
...
> Báo đỏ *"Cannot find path ... MSSQL16.KHO_C"* nghĩa là **tên instance bạn đặt
> không phải `KHO_C`**. Mở **SQL Server Configuration Manager** xem tên thật. Sai
...
Mở **SSMS** → Connect vào `.\KHO_C` (có dấu chấm và gạch chéo ngược) →
...
|---|---|---|
| `Cannot find path ... MSSQL16.KHO_C` | Đặt sai tên instance | Xem tên thật trong Configuration Manager, sai thì cài lại |
...
- [ ] Cài SSMS
- [ ] Chạy khối PowerShell mở cổng **1442** với quyền administrator
- [ ] Mở **MS DTC** cho mạng
...
Xem trước cho đỡ bỡ ngỡ. Nhóm trưởng đưa bạn file `KhoC.bak` và thư mục `SQL\`
